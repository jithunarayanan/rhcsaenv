...
config.vm.define "server2" do |server2|
  server2.vm.box = "jithu/rhel9-node"
#  server2.vm.hostname = "server2.lab.example.com"
  ...
  server2.vm.provider "virtualbox" do |server1|
